...
import static com.kingboy.mybatis.generator.GeneralConfiguration.*;
import static com.kingboy.mybatis.generator.PackageConfiguration.*;
...
public class Generator {
    ...
    public static void createByOneTable(String tableName) {
        ...
        AutoGenerator generatorDTO = new AutoGenerator()
                .setGlobalConfig(mpg.getGlobalConfig()
                        .setEntityName("%sDTO"))
                .setDataSource(mpg.getDataSource())
                .setStrategy(mpg.getStrategy())
                .setPackageInfo(mpg.getPackageInfo()
                        .setEntity(DTO_PACKAGE + (DIVIDE_MODULE ? moduleName: "")))
                .setCfg(mpg.getCfg())
                .setTemplate(mpg.getTemplate()
                        .setEntity("templates/dto.java.vm"));
        ...
        AutoGenerator generatorVO = new AutoGenerator()
                ...
                .setStrategy(mpg.getStrategy())
                .setPackageInfo(mpg.getPackageInfo()
                        .setEntity(VO_PACKAGE + (DIVIDE_MODULE ? moduleName: "")))
                .setCfg(mpg.getCfg())
                .setTemplate(mpg.getTemplate()
                        .setEntity("templates/vo.java.vm"));
        generatorVO.execute();
    }
